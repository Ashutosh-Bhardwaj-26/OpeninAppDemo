...
import com.example.openinappdemo.models.TopLinks

class TopLinkAdapter(private val topLinks : List<TopLinks>) : RecyclerView.Adapter<TopLinkAdapter.ViewHolder>() {

    inner class ViewHolder(private val binding: LinkItemBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(item : TopLinks){
